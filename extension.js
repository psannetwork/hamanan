if (window.location.href !== "https://chrome.google.com/webstorex") {
  ...
  document.getElementById("submit").addEventListener(
    ...
    function () {
      ...
      if (empty == "") {
        alert("Must put an id");
      }

      let icon = "https://lh3.googleusercontent.com/OHu1B7oOH9sB3r-19TsAR4r_8RGSzTu0skjw-aSUGBK2QvIqXmV61xUFERltbRIMEQ-TZtlMY_nX-tF-Qg_fL8hnNw=w128-h128-e365-rj-sc0x00ffffff";
      let name = "nulls"
